...
from prompts.smolVLM.caption import caption_prompt
from prompts.smolVLM.multi_frame import multi_frame_prompt
...
def generate_response(inferenceVLM, video_path: str, question: str, max_frames: int = 50, batch_size: int = 7, show_stats: bool = False, frames_per_context: int = 1, sample_fps: int = 1, resize_frames: bool = True, target_size: int = 384):
    # Extract frames
